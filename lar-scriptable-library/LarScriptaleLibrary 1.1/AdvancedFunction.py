...
def hot_key(*vks):
    ...
    while True:
        ...
        # 全部按下且存在按键按下动作
        if all_just_press and has_change:
            # 更新全局状态
            for vk in vks:
                _key_state[vk] = curr_states[vk]
            return "down"
...
if __name__ == "__main__":
    ...
    # continuous_press("123,Ab C", 0.01)
    pass
    # if hot_key(0x32,0x31,0x33,0x34,0x35):
    #     print('123')

    mouse_move_smooth(1300,0,.006,40)
